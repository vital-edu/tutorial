...
E finalmente em \emph{Criar nova comunidade}.
...
Vá ao Painel de Controle. Há um link no rodapé da página
...
Se desejar criar uma pasta, clique em \emph{Pasta}.
...
Dê um nome à pasta em \emph{Título}, e se desejar, insira uma descrição para a pasta no campo \emph{Descrição}. Para finalizar, clique em \emph{Salvar}.
...
Clique em \emph{Blog} para cria um novo blog.
